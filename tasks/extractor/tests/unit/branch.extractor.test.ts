...
describe("Branch extractor", function () {
    ...
    describe("getJiraKeys", function () {
        ...
        it("should return empty array when branchName is empty", async function () {
            // given
            branchNameProviderMock.getBranchName.withArgs(dummyProject, dummyBuildId).resolves("");

            // when
            const actual = await branchNameExtractor.getJiraKeys(dummyProject, dummyBuildId);
        ...
        it("should return jiraKey when there is no prefix and no suffix around the key", async function () {
            // given
            branchNameProviderMock.getBranchName.withArgs(dummyProject, dummyBuildId).resolves("JIE-540");
        ...
        it("should return jiraKey when there is no prefix and suffix with separator around the key", async function () {
            // given
            branchNameProviderMock.getBranchName.withArgs(dummyProject, dummyBuildId).resolves("JIE-540-suffix");
        ...
        it("should return jiraKey when there is prefix with separator and no suffix around the key", async function () {
            // given
            branchNameProviderMock.getBranchName.withArgs(dummyProject, dummyBuildId).resolves("prefix-JIE-540");
        ...
        it("should return jiraKey when there is prefix with separator and suffix with separator around the key", async function () {
            // given
            branchNameProviderMock.getBranchName.withArgs(dummyProject, dummyBuildId).resolves("prefix-JIE-540-suffix");
        ...
        it("should return first jiraKey when there is prefix with separator, suffix with separator but separator between keys", async function () {
            // given
            branchNameProviderMock.getBranchName.withArgs(dummyProject, dummyBuildId).resolves("prefix-JIE-1257-JIE-926-suffix");
        ...
        it("should return empty array when there is prefix with separator, suffix with separator but no separator between keys", async function () {
            // given
            branchNameProviderMock.getBranchName.withArgs(dummyProject, dummyBuildId).resolves("prefix-JIE-1257JIE-926-suffix");
        ...
        it("should return two jiraKeys when there is prefix with separator, suffix with separator, and infix with separator between keys", async function () {
            // given
            branchNameProviderMock.getBranchName.withArgs(dummyProject, dummyBuildId).resolves("prefix-JIE-1257-infix-JIE-926-suffix");
        ...
        it("should return empty array when there is prefix without separator and suffix without separator", async function () {
            // given
            branchNameProviderMock.getBranchName.withArgs(dummyProject, dummyBuildId).resolves("prefixJIE-1257suffix");
        ...
        it("should filter out duplicated values", async function () {
            // given
            branchNameProviderMock.getBranchName.withArgs(dummyProject, dummyBuildId).resolves("prefix-JIE-1257-infix-JIE-1257-suffix");
